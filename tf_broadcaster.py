...
class TfBroadcaster(Node):
    def __init__(self):
        ...
        self.latitude = 37.632019 # 보드에서 gps센서가 보내주는 위경도 값을 latitude, longitude에 저장
        self.longitude = 127.054919
        ...
        # PGM 및 YAML 파일 경로 설정
        self.pgm_file_path = '/home/hgy/gy_ws/src/local_pgm/map/youfuck2.pgm'
        self.yaml_file_path = '/home/hgy/gy_ws/src/local_pgm/map/youfuck.yaml'
...
# PGM 및 YAML 파일 불러오기
    ...
    def broadcast_transform(self):
        ...
        t_map_to_gps.transform.translation.x = -704.319458008
        t_map_to_gps.transform.translation.y = -839.960083008
