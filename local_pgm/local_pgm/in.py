...
class In(Node):
    def __init__(self):
        ...
        self.map_timer = self.create_timer(0.3, self.publish_map_callback)
        ...
        self.pgm_file_path = '/home/hgy/gy_ws/src/local_pgm/map/4th_floor_crop_bot.pgm'
        self.yaml_file_path = '/home/hgy/gy_ws/src/local_pgm/map/4th_floor_crop_bot.yaml'
    ...
    # map과 base_link 간의 변환도 설정
        ...
        t_map_to_base.transform.translation.x = odom_position.x
        t_map_to_base.transform.translation.y = odom_position.y
        t_map_to_base.transform.translation.z = odom_position.z
        ...
        t_map_to_base.transform.rotation = odom_orientation
